...
class HeapBufferAllocator : public BufferAllocator {
 public:
  ...
  static HeapBufferAllocator* Get() {
    static auto  allocator = new HeapBufferAllocator();
    return allocator;
  }
...
class Quota : public Mediator {
 ...
 protected:
  ...
  Mutex* mutex() const { return thread_safe ? &mutex_ : nullptr; }
...
class StaticQuota : public Quota<thread_safe> {
 ...
 protected:
  size_t GetQuotaInternal() const { return quota_; }
...
class OwningThreadSafeBufferAllocator
 ...
 public:
  ...
  ~OwningThreadSafeBufferAllocator() = default;
...
class GuaranteeMemory : public BufferAllocator {
 ...
 private:
  ...
  bool ReallocateInternal(size_t requested,
                                  ...
                                  Buffer* buffer,
                                  BufferAllocator* originator) override {
    int64 additional_memory = requested - (buffer != nullptr ? buffer->size() : 0);
