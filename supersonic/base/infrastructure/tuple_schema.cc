...
FailureOrVoid EnumDefinition::Rep::Add(const int32_t number, StringPiece name) {
...
FailureOr<StringPiece> EnumDefinition::Rep::NumberToName(int32_t number) const {
...
FailureOr<int32_t> EnumDefinition::Rep::NameToNumber(StringPiece name) const {
...
FailureOrVoid EnumDefinition::AddEntry(const int32_t number, StringPiece name) {
...
FailureOr<StringPiece> EnumDefinition::NumberToName(int32_t number) const {
  if (rep_.get() == NULL) {
...
FailureOr<int32_t> EnumDefinition::NameToNumber(StringPiece name) const {
  if (rep_.get() == NULL) {
